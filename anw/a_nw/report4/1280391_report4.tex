...
\begin{enumerate}[(1). ]
  ...
  \item このプログラムは\verb|void|型関数へのポインタという意味であり，\verb|void|を返す関数のポインタを持っている．正確には\verb|buf|という領域に確保された\verb|void|を返す関数へのポインタという意味である．
  \item よって入力された\verb|void|を返す関数を実行してしまうのだ．
  \item その機能を携えた\verb|Python|ファイルを実行することにより，バッファオーバーフローが可能になる．
