...
\begin{frame}[allowframebreaks]{参考文献}
  \begin{thebibliography}{99}
    ...
    \bibitem{anko_rsa}
    あんこ. \\
    \newblock ``RSA 暗号を理解して有名な攻撃を試してみる''. Zenn. \\
    \newblock \url{https://zenn.dev/anko/articles/ctf-crypto-rsa}

    \bibitem{atusi_rsa}
    Atsushi Hatakeyama. \\
    \newblock ``RSA暗号の仕組みを見てみよう''. Zenn. \\
    \newblock \url{https://zenn.dev/atusi/articles/aca8cd04c31a0a}

    \bibitem{jfs_rsa}
    公益社団法人日本鋳造工学会 中国四国支部. \\
    \newblock ``ITに利用される暗号化技術 RSA暗号の解説''. \\
    \newblock \url{https://jfs.or.jp/jfs-cs/crypt-rsa01/}

    \bibitem{kobayashi_rsa}
    小林 健太. \\
    \newblock ``RSA暗号の仕組み'' (PDF資料). 一橋大学. \\
    \newblock \url{https://kobayashi.hub.hit-u.ac.jp/topics/rsa.pdf}
